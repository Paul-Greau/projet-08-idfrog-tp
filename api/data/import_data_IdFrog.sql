...
L''objectif est de faciliter la recherche d''activités en fournissant des résultats le plus précis possible. Cela permettrait aux utilisateurs de trouver rapidement l''activité qui correspond à leurs besoins et aux associations/clubs de se faire connaître.',
 false),
(22, 2, 'Adopte ton mhumain', 'capital', '100000', 4,  '2024-01-01', '/data/ProjectsImages/project-1668411726029-mhumain.png', '', 'Adopte ton mhumain', 'Les chats au pouvoir !', 'Adopte ton Mhumain! est une plateforme permettant aux chats de trouver l''humain qui leur corresponde le plus. Les humains quant à eux se feront un profil afin d''être adopté par un chat. Un maître mot: Soyez le plus mignon possible! Les chats seront intransigeants! 😼', false),
(23, 18, 'Metrix', 'capital', '200000', 3.5,  '2024-06-15', '/data/ProjectsImages/project-1668411734260-metrix.png', 'https://unimetrix.xyz', 'MetriX (Reloaded)', 'Analyse de données on-chain [Web3]', 'Metrix est une application permettant de faire de l''analyse de données on-chain.
...
Nom d''un vin ! vous fait (re)découvrir des petites pépites grâce à sa box mensuelle et à ses évènements : dégustations, visites de domaines viticoles.', false),
(11, 4, 'Ofood', 'capital', '150000', 3, '2023-08-31', '/data/ProjectsImages/project-1668411830945-ofood.png', '', 'Ofood', 'Les meilleures recettes en ligne', 'Ofood est une plateforme en ligne offrant des milliers de recettes allant de plats les plus populaires aux plus exotiques et loufoques', false),
(12, 15 , 'Trapr', 'capital', '250000', 4, '2024-06-15', '/data/ProjectsImages/project-1668413366397-trapr.png', '', 'Trapr', 'Faites livrer vos produits différemment', 'Cette application Web serait utile aux producteurs et artisans afin de livrer leurs produits lors de différents déplacements.
